...
struct Tours_GetToursReply {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var items: [Tours_Tour] = []
...
fileprivate let _protobuf_package = "tours"

extension Tours_GetToursRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetToursRequest"
  ...
  func _protobuf_generated_isEqualTo(other: Tours_GetToursRequest) -> Bool {
...
extension Tours_GetToursReply: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetToursReply"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "items"),
  ]
  ...
  func _protobuf_generated_isEqualTo(other: Tours_GetToursReply) -> Bool {
...
extension Tours_Tour: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Tours_Tour) -> Bool {
